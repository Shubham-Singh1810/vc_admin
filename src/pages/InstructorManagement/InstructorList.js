...
import {
  getInstructorServ,
  addInstructorServ,
  updateInstructorServ,
  deleteInstructorServ,
...
function InstructorList() {
  ...
  const getListFunc = async () => {
    ...
    try {
      let response = await getInstructorServ(payload);
  ...
  const handleDeleteFunc = async (id) => {
    try {
      let response = await deleteInstructorServ(deleteId);
      if (response?.data?.statusCode == "200") {
        getListFunc();
 ...
 const AdminSchema = Yup.object().shape({
  ...
  const handleAddAdmin = async (values, setSubmitting) => {
    try {
      ...
      const response = await addInstructorServ(formData);
  ...
  const handleUpdateAdmin = async (values, setSubmitting) => {
    try {
      ...
      let response = await updateInstructorServ(formData);
      if (response?.data?.statusCode == "200") {
        setEditFormData({
          firstName: "",
          lastName: "",
              ...
              <div className="modal-body">
                ...
                >
                  <div className="w-100 px-2">
                    <div className="d-flex justify-content-between align-items-center">
                      <h5 className="">Add Instructor</h5>
                      <img
                        onClick={() =>
                          setAddFormData({
                            firstName: "",
            ...
            >
              <div className="modal-body">
                ...
                >
                  <div className="w-100 px-2">
                    <div className="d-flex justify-content-between align-items-center">
                      <h5 className="">Update Instructor</h5>
                      <img
                        onClick={() =>
                          setEditFormData({
                            show: false,
