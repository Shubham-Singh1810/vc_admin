...
import { getBatchDetailsServ } from "../../services/batch.services";
...
function BatchDetails() {
  ...
  const getBatchDetailsFunc = async () => {
    setShowSkelton(true);
    try {
      let response = await getBatchDetailsServ(params?.id);
  ...
  const batchSection = [
    ...
    },
    {
      ...
      fields: [
        ...
        { label: "End Date", name: "endDate", value:details?.endDate },
    ...
    <div className="container-fluid py-3">
      ...
      <div className="d-flex justify-content-between align-items-center mb-2">
        <div className="d-flex align-items-center">
          ...
          />
          <div className="ms-3">
            <h5 className="mb-1">Batch : {details?.name}</h5>
