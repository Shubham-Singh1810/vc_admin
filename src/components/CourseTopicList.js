...
import { getTopicListServ, deleteTopicServ, updateTopicServ } from "../services/courseTopic.services";
...
function CourseTopicList({ profileStatus, title }) {
      ...
      <div className="d-flex justify-content-between align-items-center my-4">
        ...
        <div className="d-flex align-items-center">
          ...
          <button
            ...
            onClick={() => navigate("/create-course-topic/" + params?.id)}
          >
            + Add Topic
          </button>
        </div>
                  ...
                  : list?.map((v, i) => {
                      return (
                        <tr>
                          ...
                          <td className="text-center">
                            <img src={v?.thumbnail} style={{height:"40px", width:"40px", borderRadius:"5px"}}/>
                          </td>
                          <td>{v?.topicName}</td>
                          ...
                          <td className="text-center">
                            <a style={{cursor:"pointer"}} href={v?.videoUrl} target="blank">
                              View
                            </a>
                          </td>
                          ...
                          <td style={{ textAlign: "center" }}>
                            {permissions?.includes("Users-Edit") && (
                              <a
                                onClick={() =>
                                  navigate("/update-course-topic/" + v?._id)
                                }
